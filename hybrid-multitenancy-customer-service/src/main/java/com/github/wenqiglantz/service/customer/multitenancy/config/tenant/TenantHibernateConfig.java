...
public class TenantHibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean tenantEntityManagerFactory(
        ...
        if (null == tenantMap) {
            ...
            tenant = tenantMap.get(TenantConstants.TENANT);
            if (!tenantMap.get(TenantConstants.PARENT_TENANT).equals(TenantConstants.MINUS_ONE)) {
                tenant = tenantMap.get(TenantConstants.PARENT_TENANT); //hierarchy scenario, resolve by hierarchy id, find its schema
            }
            //TODO
